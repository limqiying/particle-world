...
import { boxBaseGeometry, boxHorizontalSideGeometry, boxVerticalSideGeometry} from '../geometries'
...
export default class Box extends Vue{
    ...
    private createBox(): void {
        ...
        // add base board
        const base: THREE.Object3D = new THREE.Mesh(boxBaseGeometry, boxMaterial("#013220"));
